...
- `backend/`
  - Servicio Spring Boot (web) con MariaDB.
  - Contiene entidades JPA, repositorios, servicios y APIs REST.
- `frontend/`
  - Aplicacion JavaFX desacoplada.
  - Consume el backend via HTTP en `backend.api.base-url`.

## Frontend JavaFX

- `frontend/src/main/java/com/ybc/ybioq/fx`
  - Aplicacion JavaFX, navegacion, carga FXML y controladores de pantalla nuevos.
- `frontend/src/main/resources/fx`
  - Vistas FXML y estilos CSS del cliente JavaFX.

## Codigo compartido

- `backend/src/main/java/com/ybc/ybioq/entity/local`
  - Entidades JPA de la base local MariaDB `bioquimicos`.
  - La fuente de verdad es `backend/src/main/resources/bd/bioquimicos estructura.sql`.
- `backend/src/main/java/com/ybc/ybioq/repository/local`
  - Repositorios Spring Data JPA.
- `backend/src/main/java/com/ybc/ybioq/service`
  - Logica reutilizable por JavaFX.
- `backend/src/main/java/com/ybc/ybioq/controller`
...
- `backend/src/main/java/com/ybc/ybioq/api`
  - Endpoints REST usados por el frontend desacoplado (login, especialidades, medicos).

## Proyecto viejo conservado

- `backend/src/main/java/com/ybc/ybioq/view`
...
- `backend/src/main/java/com/ybc/ybioq/legacy`
...
- `backend/src/main/java/com/ybc/ybioq/config`
...
3. Cada pantalla nueva JavaFX debe consumir APIs REST del backend; no consultar repositorios ni servicios de datos directamente desde la UI.
