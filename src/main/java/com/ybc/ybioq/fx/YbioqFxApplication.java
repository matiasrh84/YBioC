...
import com.ybc.ybioq.YbioqApplication;
...
public class YbioqFxApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Thread thread = new Thread(springBootTask, "ybioq-spring-boot");
    ...
    private Task<ConfigurableApplicationContext> createSpringBootTask() {
        ...
        return new Task<>() {
            ...
            protected ConfigurableApplicationContext call() {
                return new SpringApplicationBuilder(YbioqApplication.class)
                        .headless(false)
                        .run(args);
            }
        };
