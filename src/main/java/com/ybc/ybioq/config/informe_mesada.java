 ...
 */
public class informe_mesada {
    String seccion, titulos, nombre_analisis1, nombre_analisis2, nombre_analisis3;

    public informe_mesada(String seccion, String titulos, String nombre_analisis1, String nombre_analisis2, String nombre_analisis3) {
