...
public class DetallePracticasFacturacion_nuevo extends javax.swing.JDialog {
    ...
    public DetallePracticasFacturacion_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
