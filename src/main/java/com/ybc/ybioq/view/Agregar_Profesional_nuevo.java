...
public class Agregar_Profesional_nuevo extends javax.swing.JDialog {
    ...
    public Agregar_Profesional_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        String sSQL3 = "UPDATE laboratorios SET nombre=?, apellido=?, matricula=?, direccion=?, telefono=?, cuit=?, celular=?, dni=?,usuario=?, contraseña=?, mail_direccion=?, mail_contraseña=? WHERE id_laboratorios=" + tablaProfesionales.getValueAt(tablaProfesionales.getSelectedRow(), 0).toString();
...
//        }
    ...
    private void initComponents() {
        ...
        txtClaveUsuario.setPlaceholder("Contraseña");
