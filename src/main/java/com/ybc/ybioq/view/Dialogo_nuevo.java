...
public class Dialogo_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;


    public Dialogo_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblCuerpo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
