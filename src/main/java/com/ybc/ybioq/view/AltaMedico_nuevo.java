...
public class AltaMedico_nuevo extends javax.swing.JDialog {
    ...
    public AltaMedico_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    private void btnAgregarEspecialidadActionPerformed(java.awt.event.ActionEvent evt) {
        new AltaEspecialidad_nuevo(null, true).setVisible(true);
        cargarcombo();
