...
public class TablaObrasSociales_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public TablaObrasSociales_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tablaObraSocial = new RSMaterialComponent.RSTableMetroCustom();
        ...
        tablaObraSocial.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tablaObraSocial.setBackgoundHead(new java.awt.Color(0, 90, 132));
        tablaObraSocial.setBackgoundHover(new java.awt.Color(0, 90, 132));
        tablaObraSocial.setColorBorderHead(new java.awt.Color(255, 255, 255));
        tablaObraSocial.setColorBorderRows(new java.awt.Color(255, 255, 255));
        tablaObraSocial.setGridColor(new java.awt.Color(204, 204, 204));
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(txtBuscarOS, javax.swing.GroupLayout.DEFAULT_SIZE, 636, Short.MAX_VALUE))
                                .addContainerGap())
        );
    ...
    private RSMaterialComponent.RSTableMetroCustom tablaObraSocial;
