...
public class VistaPrevia_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public VistaPrevia_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtEncabezado = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        lblLogo.setForeground(new java.awt.Color(0, 90, 132));
        lblLogo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblLogo.setText("logo");
        lblLogo.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        txtEncabezado.setForeground(new java.awt.Color(0, 90, 132));
        txtEncabezado.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtEncabezado.setPhColor(new java.awt.Color(0, 90, 132));
        txtEncabezado.setPlaceholder("Título");
        txtEncabezado.setSelectionColor(new java.awt.Color(0, 90, 132));
        ...
        jPanel4Layout.setHorizontalGroup(
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(txtEncabezado, javax.swing.GroupLayout.DEFAULT_SIZE, 641, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                ...
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtEncabezado, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private RSMaterialComponent.RSTextFieldMaterial txtEncabezado;
