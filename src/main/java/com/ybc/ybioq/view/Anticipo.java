...
public class Anticipo extends javax.swing.JDialog {

    private int x;
    private int y;

    public Anticipo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtAnticipo = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        jLabel1.setText("Pago del anticipo");

        txtAnticipo.setForeground(new java.awt.Color(0, 90, 132));
        txtAnticipo.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtAnticipo.setPhColor(new java.awt.Color(0, 90, 132));
        txtAnticipo.setPlaceholder("Anticipo");
        txtAnticipo.setSelectionColor(new java.awt.Color(0, 90, 132));
    ...
    private RSMaterialComponent.RSTextFieldMaterial txtAnticipo;
