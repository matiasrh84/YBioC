...
public class Usuarios_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public Usuarios_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rSPasswordMaterial2.setPlaceholder("Repetir contraseña");
