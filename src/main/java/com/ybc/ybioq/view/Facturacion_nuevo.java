...
public class Facturacion_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public Facturacion_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtMes = new RSMaterialComponent.RSTextFieldMaterial();
        txtAño = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        tablaFacturacion = new RSMaterialComponent.RSTableMetroCustom();
        jPanel4 = new javax.swing.JPanel();
        btnCerrarPeriodo = new RSMaterialComponent.RSButtonMaterialIconOne();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Periodo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 10), new java.awt.Color(0, 90, 132))); // NOI18N

        txtMes.setForeground(new java.awt.Color(0, 90, 132));
        txtMes.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtMes.setPhColor(new java.awt.Color(0, 90, 132));
        txtMes.setPlaceholder("Mes");
        txtMes.setSelectionColor(new java.awt.Color(0, 90, 132));

        txtAño.setForeground(new java.awt.Color(0, 90, 132));
        txtAño.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtAño.setPhColor(new java.awt.Color(0, 90, 132));
        txtAño.setPlaceholder("Año");
        txtAño.setSelectionColor(new java.awt.Color(0, 90, 132));
        ...
        tablaFacturacion.setBackgoundHead(new java.awt.Color(0, 90, 132));
        tablaFacturacion.setBackgoundHover(new java.awt.Color(0, 90, 132));
        tablaFacturacion.setColorBorderHead(new java.awt.Color(255, 255, 255));
        tablaFacturacion.setColorBorderRows(new java.awt.Color(255, 255, 255));
        tablaFacturacion.setGridColor(new java.awt.Color(204, 204, 204));
        ...
        btnCerrarPeriodo.setBackground(new java.awt.Color(0, 90, 132));
        btnCerrarPeriodo.setText("Cerrar periodo y descargar DDJJ");
        btnCerrarPeriodo.setBackgroundHover(new java.awt.Color(204, 204, 204));
        btnCerrarPeriodo.setForegroundIcon(new java.awt.Color(0, 90, 132));
        btnCerrarPeriodo.setForegroundIconHover(new java.awt.Color(0, 90, 132));
        btnCerrarPeriodo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnCerrarPeriodo.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.VERIFIED_USER);
        btnCerrarPeriodo.setRound(20);
        ...
        btnImprimirResumen.setText("Imprimir resumen de una O.S.");
        btnImprimirResumen.setBackgroundHover(new java.awt.Color(204, 204, 204));
        btnImprimirResumen.setForegroundIcon(new java.awt.Color(0, 90, 132));
        ...
        jPanel4Layout.setHorizontalGroup(
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(btnCerrarPeriodo, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnImprimirResumen, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnCerrarPeriodo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnSalir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnImprimirResumen, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap())
        );
    ...
    private RSMaterialComponent.RSButtonMaterialIconOne btnCerrarPeriodo;
    ...
    private RSMaterialComponent.RSTableMetroCustom tablaFacturacion;
    private RSMaterialComponent.RSTextFieldMaterial txtAño;
    private RSMaterialComponent.RSTextFieldMaterial txtBuscar;
    private RSMaterialComponent.RSTextFieldMaterial txtMes;
