...
public class Cantidad extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtCantidad.setForeground(new java.awt.Color(0, 90, 132));
        txtCantidad.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtCantidad.setPhColor(new java.awt.Color(0, 90, 132));
        txtCantidad.setPlaceholder("Cantidad");
        txtCantidad.setSelectionColor(new java.awt.Color(0, 90, 132));
