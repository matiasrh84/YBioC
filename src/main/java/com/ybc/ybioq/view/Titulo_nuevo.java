...
public class Titulo_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public Titulo_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tablaTitulos = new RSMaterialComponent.RSTableMetroCustom();
        ...
        btnGuardar.setBackground(new java.awt.Color(0, 90, 132));
        btnGuardar.setText("Guardar");
        btnGuardar.setBackgroundHover(new java.awt.Color(204, 204, 204));
        btnGuardar.setForegroundIcon(new java.awt.Color(0, 90, 132));
        btnGuardar.setForegroundIconHover(new java.awt.Color(0, 90, 132));
        ...
        txtTitulo.setSelectionColor(new java.awt.Color(0, 90, 132));
        ...
        tablaTitulos.setBackgoundHead(new java.awt.Color(0, 90, 132));
        tablaTitulos.setBackgoundHover(new java.awt.Color(0, 90, 132));
        tablaTitulos.setColorBorderHead(new java.awt.Color(255, 255, 255));
        tablaTitulos.setColorBorderRows(new java.awt.Color(255, 255, 255));
        tablaTitulos.setGridColor(new java.awt.Color(204, 204, 204));
    ...
    private RSMaterialComponent.RSTableMetroCustom tablaTitulos;
