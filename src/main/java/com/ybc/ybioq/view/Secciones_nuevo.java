...
public class Secciones_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public Secciones_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtNombreSeccion.setPlaceholder("Sección");
