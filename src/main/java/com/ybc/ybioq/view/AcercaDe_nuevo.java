...
public class AcercaDe_nuevo extends javax.swing.JDialog {


    public AcercaDe_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/iso nuevo ybc121.png"))); // NOI18N

        jLabel6.setFont(new java.awt.Font("NewsGoth Lt BT", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(102, 102, 102));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Yerba Buena Computación");

        jLabel9.setFont(new java.awt.Font("NewsGoth Lt BT", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(102, 102, 102));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("www.ybc.com.ar");
