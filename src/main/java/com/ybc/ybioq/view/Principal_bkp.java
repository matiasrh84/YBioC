...
//        });
    ...
    void CargaTotalesPrecios() {
        double totalOS, totalAnticipo, sumatoria;
        totalParticular = 0.0;
        ...
        if (lblAnticipo.getText().isEmpty()) {
            totalAnticipo = 0;
        } else {
            totalAnticipo = Double.parseDouble(lblAnticipo.getText());
        }
        sumatoria = totalOS + totalParticular - totalAnticipo;
        System.out.println("sumatoria = totalOS + totalParticular - totalAnticipo;" + sumatoria + " " + totalOS + " " + totalParticular + " " + totalAnticipo);
...
//        textAutoAcompleter2.setCaseSensitive(false);
    ...
    void cargarperiodo() {
        ...
        for (i = 6; i <= 9; i++) {
            periodo2 = periodo2 + fecha.charAt(i);
        }
        for (i = 8; i <= 9; i++) {
            dia2 = dia2 + fecha.charAt(i);
        }
        periodo = periodo2 + mes2;
    }
...
//        }
    ...
    private void initComponents() {
        ...
        lblAnticipo = new javax.swing.JTextField();
        ...
        btnAnticipos = new RSMaterialComponent.RSButtonMaterialIconOne();
        ...
        jLabel39.setText("anticipo $");

        lblAnticipo.setEditable(false);
        lblAnticipo.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lblAnticipo.setForeground(new Color(102, 0, 51));
        lblAnticipo.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        lblAnticipo.setText("0");
        lblAnticipo.setBorder(null);
        lblAnticipo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lblAnticipoActionPerformed(evt);
            }
        });
                ...
                jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel14Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(lblAnticipo, javax.swing.GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE))
                                .addContainerGap())
        );
                ...
                jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel14Layout.createSequentialGroup()
                                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(lblAnticipo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        btnAnticipos.setBackground(new Color(0, 90, 132));
        btnAnticipos.setBackgroundHover(new Color(204, 204, 204));
                        ...
                        .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                                                ...
                                                .addGap(149, 149, 149)
                                                .addComponent(btnAnticipos, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                ...
                jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(btnAnticipos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
    ...
    private void lblAnticipoActionPerformed(java.awt.event.ActionEvent evt) {
    }
    ...
    private void btnAnticiposActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private RSMaterialComponent.RSButtonMaterialIconOne btnAnticipos;
    ...
    private javax.swing.JTextField lblAnticipo;
