...
public class Login_nuevo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtContraseña.setForeground(new java.awt.Color(0, 90, 132));
        txtContraseña.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtContraseña.setPhColor(new java.awt.Color(0, 90, 132));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        this.dispose();
        new Principal_nuevo().setVisible(true);
