...
public class Proxima_Orden_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public Proxima_Orden_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jPanel3Layout.setHorizontalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(txtNumeroOrden, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addContainerGap())
        );
    ...
    private void txtNumeroOrdenKeyPressed(KeyEvent evt) {//GEN-FIRST:event_txtNumeroOrdenKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {

            if (!txtNumeroOrden.getText().equals("")) {
                dispose();
            }
