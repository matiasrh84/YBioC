...
public class MensajeMail_nuevo extends javax.swing.JDialog {

    private int x;
    private int y;

    public MensajeMail_nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtCuerpoMensaje = new RSMaterialComponent.RSTextFieldMaterial();
        txtAsunto = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        txtCuerpoMensaje.setForeground(new java.awt.Color(0, 90, 132));
        txtCuerpoMensaje.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtCuerpoMensaje.setPhColor(new java.awt.Color(0, 90, 132));
        txtCuerpoMensaje.setPlaceholder("Cuerpo del mensaje");
        txtCuerpoMensaje.setSelectionColor(new java.awt.Color(0, 90, 132));

        txtAsunto.setForeground(new java.awt.Color(0, 90, 132));
        txtAsunto.setColorMaterial(new java.awt.Color(0, 90, 132));
        txtAsunto.setPhColor(new java.awt.Color(0, 90, 132));
        txtAsunto.setPlaceholder("Asunto");
        txtAsunto.setSelectionColor(new java.awt.Color(0, 90, 132));
                ...
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtAsunto, javax.swing.GroupLayout.DEFAULT_SIZE, 534, Short.MAX_VALUE)
                                        .addComponent(txtCuerpoMensaje, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtCuerpoMensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private RSMaterialComponent.RSTextFieldMaterial txtAsunto;
    private RSMaterialComponent.RSTextFieldMaterial txtCuerpoMensaje;
